...
// stage content:
(lib._2_37A1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_36_BE-A1.html", "_self");
		}
	}
	...
	this.text.parent = this;
	this.text.setTransform(147,301.8,1.439,1.53);
	...
	// 圖框
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00CCFF").s().p("A7aPoQgkAAgfgOQglgQgdgjQg4hBAAhYIAA4aQAAg6AYgxQAMgZAUgVQA2hBBPAAMA21AAAQBPAAA4BBQASAVANAZQAXAxAAA6IAAYaQAABYg2BBQgfAjglAQQggAOgjAAg");
