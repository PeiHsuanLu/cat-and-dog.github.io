...
// stage content:
(lib._2_15_1_Q = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_15_dog-angry.html", "_self");
		}
		...
		*/
		...
		function fl_ClickToGoToWebPage_2() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_18_dog-eating.html", "_self");
		}
	}
	...
	// 文字
	this.text = new cjs.Text("「貓貓好奇怪喔⋯\n但真擔心再得罪他⋯」", "12px 'Heiti TC'");
	this.text.lineHeight = 16;
	this.text.lineWidth = 123;
	this.text.parent = this;
	this.text.setTransform(150.9,411.7,1.439,1.53);

	this.text_1 = new cjs.Text("「貓貓都不理我⋯不管了，\n我還是直接跟他說清楚！」", "12px 'Heiti TC'");
	this.text_1.lineHeight = 16;
	this.text_1.lineWidth = 147;
	this.text_1.parent = this;
	this.text_1.setTransform(133.8,223.1,1.439,1.53);
