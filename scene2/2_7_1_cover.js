...
// stage content:
(lib._2_7_1_cover = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_19 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_7_dog-lolipop.html", "_self");
		}
	}
	...
	// 文字
	this.text = new cjs.Text("狗狗被貓貓冷淡回應之後，\n這幾天他們都沒有見面。\n狗狗今天依舊去便利商店，\n買了他最愛的點心吃⋯", "14px 'Heiti TC'");
	this.text.lineHeight = 18;
	this.text.lineWidth = 169;
	this.text.parent = this;
	this.text.setTransform(118.7,288,1.439,1.53);
