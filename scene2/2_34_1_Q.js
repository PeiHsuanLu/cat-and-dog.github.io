...
// stage content:
(lib._2_34_1_Q = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_34_cat-give-a-damn.html", "_self");
		}
		...
		*/
		...
		function fl_ClickToGoToWebPage_2() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_35_cat-dog-water-gun.html", "_self");
		}
	}
	...
	// 文字
	this.text = new cjs.Text("「你不介意上次我對你\n發脾氣的事嗎？」", "12px 'Heiti TC'");
	this.text.lineHeight = 16;
	this.text.lineWidth = 123;
	this.text.parent = this;
	this.text.setTransform(151.4,411.7,1.439,1.53);

	this.text_1 = new cjs.Text("「哼，現在才不想跟你玩呢！」", "12px 'Heiti TC'");
	this.text_1.lineHeight = 16;
	this.text_1.lineWidth = 171;
	this.text_1.parent = this;
	this.text_1.setTransform(116.5,235.3,1.439,1.53);
