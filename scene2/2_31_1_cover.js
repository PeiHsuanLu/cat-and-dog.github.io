...
// stage content:
(lib._2_31_1_cover = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_31_cat-dont-understand.html", "_self");
		}
	}
	...
	// 文字
	this.text = new cjs.Text("貓貓生氣地走在路上，\n邊走還邊踢到石頭，\n就這樣一路回到家。", "14px 'Heiti TC'");
	this.text.lineHeight = 18;
	this.text.lineWidth = 143;
	this.text.parent = this;
	this.text.setTransform(137,301.8,1.439,1.53);
