...
// stage content:
(lib._2_26_1_cover = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_26_cat-hello.html", "_self");
		}
	}
	...
	// 文字
	this.text = new cjs.Text("即便貓貓很不能理解狗狗，\n但看他這幾天都沒來上學，\n貓貓還是很擔心，\n所以他來到了狗狗家⋯", "14px 'Heiti TC'");
	this.text.lineHeight = 18;
	this.text.lineWidth = 170;
	this.text.parent = this;
	this.text.setTransform(118,288,1.439,1.53);
