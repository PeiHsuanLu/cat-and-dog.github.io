...
// stage content:
(lib._2_13_1_cover = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage() {
			window.open("https://peihsuanlu.github.io/cat-and-dog.github.io/scene2/2_13_dog-with-snack.html", "_self");
		}
	}
	...
	// 文字
	this.text = new cjs.Text("即使貓貓冷淡回應，\n狗狗仍然不放棄，\n他拿出剛剛買好的點心，\n追上貓貓⋯", "14px 'Heiti TC'");
	this.text.lineHeight = 18;
	this.text.lineWidth = 154;
	this.text.parent = this;
	this.text.setTransform(129,288,1.439,1.53);
